  ...
  return (
    ...
    >
      <div
        ...
        className="bg-white w-full max-w-2xl rounded-t-3xl sm:rounded-3xl shadow-2xl border border-slate-200 overflow-hidden my-0 sm:my-8 max-h-[94dvh] flex flex-col animate-in slide-in-from-bottom-4 sm:zoom-in-95 duration-200"
      ...
      >
        ...
        <div className="bg-gradient-to-r from-[#064E3B] to-[#047857] text-white p-5 sm:p-8 relative shrink-0">
          ...
          <p className="text-emerald-100 text-sm mt-2 max-w-lg leading-relaxed">
            Get personal advice for your business, website, or marketing questions directly from
            Lamlak.
          </p>
        </div>
          ...
          {isSubmitted ? (
            <div className="text-center py-8 space-y-4">
              ...
              <p className="text-slate-600 text-sm max-w-md mx-auto leading-relaxed">
                Thank you,{' '}
                <span className="font-semibold text-slate-900">{formData.name}</span>. Lamlak
                will email you at{' '}
                <span className="font-medium text-slate-900">{formData.email}</span> within 24
                hours to confirm your time and send a link.
              </p>
              <div className="pt-4">
                <button
                  onClick={handleReset}
              ...
              {step === 1 ? (
                ...
                <div className="space-y-4">
                  ...
                  <div className="pt-2 flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-between gap-3">
                    ...
                    <button
                      type="submit"
                      className="inline-flex items-center justify-center gap-2 min-h-[48px] bg-[#064E3B] hover:bg-[#022c22] text-white text-sm font-semibold px-7 py-3 rounded-full cursor-pointer shadow-sm w-full sm:w-auto"
                    >
